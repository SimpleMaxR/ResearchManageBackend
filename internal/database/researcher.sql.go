...
RETURNING researcherid, labid, name, gender, title, age, researchdirection, leader
`
...
SELECT researcherid, labid, name, gender, title, age, researchdirection, leader FROM Researchers WHERE ResearcherID = $1
`
...
SELECT researcherid, labid, name, gender, title, age, researchdirection, leader FROM Researchers
`
...
SELECT researcherid, labid, name, gender, title, age, researchdirection, leader FROM Researchers WHERE LabID = $1
`

func (q *Queries) ListResearcherByLab(ctx context.Context, labid sql.NullInt32) ([]Researcher, error) {
